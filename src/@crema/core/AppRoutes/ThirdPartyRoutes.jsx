...
import ColorPickercopy from '../../../modules/thirdParty/reactColor/indexcopy';
...
import ReactDropzonecopy from '../../../modules/thirdParty/reactDropzone/indexcopy';
import DriverChart from '../../../modules/thirdParty/reactDropzone/chartcopy';
...
export const thirdPartyConfigs = [
  ...
  {
    permittedRole: RoutePermittedRole.User,
    path: '/third-party/react-colorcopy',
    element: <ColorPickercopy />,
  },
  {
    permittedRole: RoutePermittedRole.User,
  ...
  {
    permittedRole: RoutePermittedRole.User,
    path: '/third-party/react-dropzonecopy',
    element: <ReactDropzonecopy />,
  },
  {
    permittedRole: RoutePermittedRole.User,
  ...
  {
    permittedRole: RoutePermittedRole.User,
    path: '/third-party/react-chartcopy',
    element: <DriverChart />,
  },
];
