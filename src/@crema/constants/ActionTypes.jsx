...
export const APPLY_DISCOUNT = 'cart/applyDiscount';
export const APPLY_TAX = 'cart/applyTax';
export const APPLY_SHIPPING_CHARGE = 'cart/applyShippingCharge';

// Address Action Types
export const ADD_ADDRESS = 'address/addAddress';
export const UPDATE_ADDRESS = 'address/updateAddress';
export const REMOVE_ADDRESS = 'address/removeAddress';
export const SELECT_ADDRESS = 'address/selectAddress';
